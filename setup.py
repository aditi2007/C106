...
def setup():
    data_path  = r"C:\Users\a2z\Downloads\Data-visualization-master\Data-visualization-master\csv files\Ice-Cream vs Cold-Drink vs Temperature - Ice Cream Sale vs Temperature data.csv"
